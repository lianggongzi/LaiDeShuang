...
import com.example.administrator.laideshuang.filemanager.FileManager;
...
//				myHandler.sendEmptyMessageDelayed(0, 100);
    ...
    private boolean excelToSheet(String file) {
        ...
        for (DataBean dataBean : list) {
            Log.d("feng",dataBean.toString());
            bean.setWaibuNumber(dataBean.getWaibuNumber());
            bean.setAoshiNumber(dataBean.getAoshiNumber());
            bean.setFenyunNumber(dataBean.getFenyunNumber());
